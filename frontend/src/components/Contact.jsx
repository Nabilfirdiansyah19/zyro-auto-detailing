...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-32 bg-[#000000] relative overflow-hidden">
      {/* Background Decor (Blurry Glow) */}
      <div className="absolute top-1/2 left-0 w-[400px] h-[400px] bg-magenta-300/10 blur-[150px] rounded-full -translate-y-1/2" />
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-20">
          ...
          >
            <h2 className="text-6xl md:text-8xl font-black text-white italic uppercase leading-[0.8] mb-10 tracking-tighter">
              LET'S <br /> <span className="text-magenta-300">UPGRADE.</span>
            </h2>
            ...
            <div className="space-y-4">
              {contactInfo.map((item, i) => (
                <div key={i} className="flex gap-6 items-center p-6 rounded-[2rem] bg-[#0a0a0a] border border-white/5 shadow-[8px_8px_16px_#000000,-4px_-4px_16px_rgba(255,255,255,0.02)]">
                  <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-magenta-300">
                    <item.icon size={20} />
                  </div>
                  <div>
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-10 text-magenta-300">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-4">
                <input 
                  ...
                  className="w-full p-5 bg-black/40 border border-white/10 rounded-2xl text-white text-[10px] font-black tracking-widest focus:border-magenta-300 outline-none transition-all placeholder:text-gray-700 uppercase"
                />
                <input 
                  type="text" 
              ...
              <textarea 
                ...
                className="w-full p-5 bg-black/40 border border-white/10 rounded-2xl text-white text-[10px] font-black tracking-widest focus:border-magenta-300 outline-none transition-all placeholder:text-gray-700 uppercase resize-none"
              />
              
              <button className="w-full py-5 bg-white text-black font-black uppercase text-[10px] tracking-[0.3em] rounded-2xl flex items-center justify-center gap-3 hover:bg-magenta-300 hover:text-white transition-all duration-500">
