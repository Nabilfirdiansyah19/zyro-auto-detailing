...
const Footer = () => {
  return (
    <footer id="footer" className="bg-black text-white py-12 md:py-16 border-t border-white/10 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="inline-block bg-magenta-300 hover:bg-red-700 text-white text-sm font-bold py-2.5 px-6 rounded-full transition-colors"
            >
              Open On Google Maps
            </a>
          </div>
