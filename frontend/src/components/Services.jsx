...
const Services = () => {
  ...
  return (
    <section id="services" className="py-32 bg-[#000000]">
      <div className="container mx-auto px-6 text-center mb-24">
        <h2 className="text-6xl font-black text-white italic uppercase tracking-tighter">TECHNICAL <br /> <span className="text-magenta-300">SOLUTIONS.</span></h2>
      </div>
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {serviceList.map((s, i) => (
          ...
          >
            <div>
              <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-magenta-300 mb-8 border border-white/5">
                <s.icon size={24} />
              </div>
              ...
              <div className="space-y-3 mb-10">
                {s.features.map((f, idx) => (
                  <div key={idx} className="flex gap-2 items-center">
                    <Check size={10} className="text-magenta-300" />
            ...
            <div className="pt-6 border-t border-white/5 flex justify-between items-center">
              ...
              <button className="text-magenta-300 font-black uppercase text-[9px] tracking-widest hover:translate-x-2 transition-transform italic">Details →</button>
            </div>
          </motion.div>
        ))}
      </div>
